(function() {
  module.exports = function(app) {
    ...
    app.get('/message-notifications', decorators.loginRequired, function(req, res) {
      return models.Notification.find({
        recipient: req.user.id,
        type: 1,
        deleted: false
        ...
        return res.render('notification/message-notifications', {
          userNotif: nots
        });
      }).fail(function(reason) {
        logger.error(reason);
    ...
    app.get('/getMessageNotifications', decorators.loginRequired, function(req, res) {
      return models.Notification.find({
        recipient: req.user.id,
        type: 1,
        read: false,
