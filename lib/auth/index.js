  ...
  module.exports = function(app) {
    ...
    passport.deserializeUser(function(id, done) {
      return models.User.findOne({
        _id: id,
        active: true
      }, {hashedPassword: 0, salt: 0}).exec(function(err, user) {
    ...
    app.post('/accounts/login', function(req, res, next) {
      ...
      req.assert('password', {
        len: 'Should have between 4 - 24 characters.'
      }).len(2);
    ...
    app.post('/accounts/user/photo/upload', decorators.loginRequired, function(req, res, next) {
      var user;
