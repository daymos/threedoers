  ...
  STLStats = (function() {
    ...
    STLStats.prototype.getVolume = function(unit) {
      ...
      if (!this.flag) {
        ...
        return this.calculateVolume().then((function(_this) {
          return function(v) {
            _this.volume = v;
            _this.flag = true;
            return _volume();
    ...
    STLStats.prototype.calculateVolume = function() {
      ...
      partialCalculate = function() {
        return that.gridStore.tell((function(_this) {
      ...
      totalVolume = 0;
      this.read_header().then((function(_this) {
        return function() {
    ...
    STLStats.prototype.read_header = function() {
      ...
      var deferred;
      deferred = q.defer();
      this.gridStore.tell((function(_this) {
        return function(err, position) {
          if (err) {
            return deferred.reject(err);
          } else {
    ...
    STLStats.prototype.read_triangle = function() {
       ...
       */
      return this.my_unpack("3f", 12).then((function(_this) {
        return function(n) {
