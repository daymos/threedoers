(function() {
  var Comment, ObjectId, PROJECT_COLORS, PROJECT_DENSITIES, PROJECT_STATUSES, STLProject, Schema, gridfs, mongoose,
  ...
  STLProject.methods.addFile = function(file, options) {
    ...
    return gridfs.putFile(file.path, name, options).then((function(_this) {
      return function(doc) {
