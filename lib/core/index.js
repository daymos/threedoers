(function() {
  module.exports = function(app, io) {
    var PostMaster, STLStats, auth, calculateOrderPrice, decimal, decorators, exec, fs, gridfs, handleDirection, logger, mailer, models, paypal, processVolumeWeight, settings, utils;
    fs = require('fs');
