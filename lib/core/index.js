      ...
      if (req.body.object_id) {
        return models.STLProject.findOne({
          ...
          if (doc) {
            ...
            console.log(req.body.tracking_status && req.body.tracking_status.status === "TRANSIT" && !doc.order.secundaryPaid);
            console.log(req.body.tracking_status, req.body.tracking_status.status === "TRANSIT", !doc.order.secundaryPaid);
            if (req.body.tracking_status && req.body.tracking_status.status === "TRANSIT") {
