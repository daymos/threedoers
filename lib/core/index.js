(function() {
  module.exports = function(app, io) {
    var STLStats, auth, calculateOrderPrice, decimal, decorators, exec, fs, gridfs, handleDirection, logger, mailer, models, paypal, processVolumeWeight, request, requestShippingRate, settings, shippo, utils;
    fs = require('fs');
    ...
    app.post('/project/pay/:id', decorators.loginRequired, function(req, res, next) {
      return models.STLProject.findOne({
        ...
        var paypalSdk, printerPayment, totalPayment;
