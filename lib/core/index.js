  ...
  module.exports = function(app, io) {
    ...
    app.post('/goshippo-webhook/', function(req, res) {
      if (req.body.object_id) {
        return models.STLProject.where('order.shipping.object_id').equals(req.body.object_id).exec().then(function(doc) {
          ...
          if (doc) {
            ...
            if (req.body.tracking_status && req.body.tracking_status === "TRANSIT" && !doc.order.secundaryPaid) {
