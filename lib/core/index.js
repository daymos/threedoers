...
//todo https://trello.com/c/ZnMejTT6/44-a-printer-cannot-see-the-the-file-uploaded-by-himself-to-print
    app.get('/printing/requests', decorators.printerRequired, function(req, res) {
      return models.STLProject.find({
        ...
        'user':{'$ne' : req.user.id},//https://stackoverflow.com/questions/16531895/mongoose-query-where-value-is-not-null
        'order.printer': req.user.id
    ...
    app.post('/printing/accept/:id', decorators.printerRequired, function(req, res) {
      return models.STLProject.findOne({
        'user':{'$ne' : req.user.id}, //https://trello.com/c/ZnMejTT6/44-a-printer-cannot-see-the-the-file-uploaded-by-himself-to-print
        '_id' : req.params.id
      }).exec().then(function(doc) {
