      ...
      if (req.body.object_id) {
        return models.STLProject.findOne({
          ...
          if (doc) {
            ...
            console.log(req.body.tracking_status != null, req.body.tracking_status.status.match(/TRANSIT/), !doc.order.secundaryPaid);
            if ((req.body.tracking_status != null) && req.body.tracking_status.status.match(/TRANSIT/) && !doc.order.secundaryPaid) {
