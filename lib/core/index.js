(function() {
  module.exports = function(app, io) {
    ...
    app.get('/stampa3D', function(req, res) {
      return res.render('core/stampa3D');
    });
    ...
    app.get('/walkthrough', decorators.loginRequired, function(req, res) {
      return res.render('home/walkthrough');
    });
    app.get('/resources', decorators.loginRequired, function(req, res) {
      return res.render('resources/resources');
    });
    app.get('/file3d', decorators.loginRequired, function(req, res) {
      return res.render('resources/file_3d');
    });
    app.get('/3dprinter', decorators.loginRequired, function(req, res) {
      return res.render('resources/3d_printer');
    });
    app.get('/materials', decorators.loginRequired, function(req, res) {
      return res.render('resources/materials');
    });
    app.get('/about', decorators.loginRequired, function(req, res) {
      return res.render('resources/about_us');
    });
