    ...
    return $("#comment-button").click(function(e) {
      ...
      return $.ajax({
        ...
        success: function(data) {
          var template;
          template = "<li class='list-group-item'>              <div class='row'>                <div class='col-xs-2 col-md-1'><img src='http://placehold.it/80' alt='' class='img-circle img-responsive'></div>                <div class='col-xs-10 col-md-11'>                  <div>                   <div class='mic-info'>By: &nbsp; &nbsp;<a href='#'>" + data.username + "</a>&nbsp;on " + (Date(data.createdAt)) + "</div>                  </div><br>                  <div class='comment-text'>" + (safe_tags_replace(data.content)) + "</div>                </div>              </div>            </li>";
