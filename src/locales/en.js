{
  ...
  "Materials Page 0": "MATERIALS",
  "Materials Page 1": "3doers mainly employs ABS and PLA, widespread and versatile materials that perfectly fit with different product applications.",
  "Materials Page 2": "For our business clients it’s also possible, upon request, to print with other materials.",
  "About Page 0": "ABOUT US",
  "About Page 1": "3doers is an online platform dedicated to Crowdsourced 3D printing, meant to join different users and professionals to allow students and professional designers to print their own prototypes and projects. 3doers is directed towards: simple users, who can order the print for their own 3D models; 3D printer owners, who are asked to pick up and execute printing commissions; 3D modeling experts, employed to model files to create the correct base to start a project, ready-made for use. The platform receives a commission fee on each order served: file revision and/or 3D printing.",
  "About Page 2": "3doers’ network aims to connect and create a community to unite those who are looking to realize physically their idea or their models and those who wish to put their skills and equipment to good use. 3doers’ automated system makes for a fast and safe printing process, that allows the simple user to be safeguarded during purchase and all the way to the shipment, and allows printers to comfortably work on the projects they choose to pick up, while following their own printing times and abilities.",
  "About Page 3": "With 3doers, the client will be able to get a fully customized item, order additional printing features for their model, get the item they ordered in fast times and for lower prices compared to big-scale professional workshops – all thanks to 3doers’ own workshop and to the printers who provide their knowledge and equipment. Printers are safeguarded as well during the printing process, they can choose which models and orders to work on and they can get in touch with their clients to achieve an experience that is profitable for both parts.",
  "About Page 4a": "WHO WE ARE",
  "About Page 4": "Founder",
  "About Page 5": "Founder",
  "About Page 6": "With a PhD in Communication Sciences and currently getting a degree in Electrical engineering, Mattia is an IT expert, proficient in 3D modeling and prototype development. He handles 3doers’ IT side and product design.",
  "About Page 7": "With a PhD in Communication Sciences, Marco has worked for Ferrero, Fiat and Banca Sella in the fields of marketing and finance. Making enthusiast, he handles the project’s business side.",
  ...
  "About Page 11": "OUR MISSION",
  "About Page 12": "3doers aims to promote the Do-It-Yourself culture, even in this innovative field that is, seemingly, not within the general public’s reach. Our goal is also that to give a chance to 3D printer owners to put their skills to good use, cash in on the initial cost of getting the equipment and create a skill-set for themselves and visibility in the field through 3doers’ workshop and community.",
  "About Page 13": "3D printing is indeed within everyone’s reach and, through 3doers, those who are looking to create their models and physically recreate their ideas can find a way to do so thanks to the modeling experts and printers that converge on the platform.",
  "About Page 14": "Thanks to 3doers i twill be possible for students, simple users and small businesses to gain access to an advanced technology with lowered costs and in a safe environment."
}
