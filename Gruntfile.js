  ...
  grunt.initConfig({
    ...
    concat: {
      js: {
        ...
        src: ['src/public/js/lib/modernizr.js', 'src/public/js/lib/jquery.js', 'src/public/js/lib/jquery.migrate.js', 'src/public/js/lib/main.js', 'src/public/js/lib/**/*.js'],
    ...
    copy: {
      assets: {
        expand: true,
        cwd: 'src/public/',
        src: ['css/application.css', 'css/comming.css', 'css/backend.css', 'favicon.ico', 'js/application.js', 'js/site.js', 'js/common.js', 'js/lib.js', 'js/views/*.js', 'vendor/*.js', 'tmp/.gitignore', 'img/*.png', 'img/*.jpg', 'images/*.png', 'images/*.jpg', 'fonts/**'],
        dest: 'public/'
      },
      views: {
        expand: true,
