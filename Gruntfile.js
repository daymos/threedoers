  ...
  grunt.initConfig({
    ...
    copy: {
      assets: {
        expand: true,
        cwd: 'src/public/',
        src: ['css/application.css', 'css/comming.css', 'css/backend.css', 'js/application.js', 'js/site.js', 'js/common.js', 'js/lib.js', 'js/views/*.js', 'vendor/*.js', 'tmp/.gitignore', 'img/*.png', 'img/*.jpg', 'images/*.png', 'images/*.jpg', 'fonts/**'],
        dest: 'public/'
      },
      views: {
        expand: true,
